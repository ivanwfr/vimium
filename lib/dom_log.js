...
const DOM_LOG_JS_TAG       = DOM_LOG_JS_ID  +" (251013:20h:01)";  /* eslint-disable-line no-unused-vars */
/*}}}*/
...
let logX = (msg,l_x) => {
    ...
    msg = msg.replace(/\n/g,"\u21B2");
    if( msg.length                  >           LEN_MAX+3)
        msg = mPadEnd(msg.substring(0,LEN_MAX), LEN_MAX+3, ".");
